...
var TR = {
  zh: {
    plugin_name: "\u65E0\u7EBF\u5C40\u57DF\u7F51\u4F20\u8F93",
    ribbon_tooltip: "\u6253\u5F00\u65E0\u7EBF\u4F20\u8F93\u9762\u677F",
    server_started: "\u65E0\u7EBF\u670D\u52A1\u5DF2\u542F\u52A8 (\u7AEF\u53E3 {0})",
    server_stopped: "\u670D\u52A1\u5DF2\u505C\u6B62",
    port_in_use: "\u274C \u7AEF\u53E3 {0} \u88AB\u5360\u7528\uFF0C\u8BF7\u5728\u8BBE\u7F6E\u4E2D\u66F4\u6539\uFF01",
    start_failed: "\u274C \u670D\u52A1\u542F\u52A8\u5931\u8D25",
    saved: "\u5DF2\u4FDD\u5B58",
    error: "\u9519\u8BEF",
    status_running: "\u{1F7E2} \u670D\u52A1\u8FD0\u884C\u4E2D",
    status_stopped: "\u{1F534} \u670D\u52A1\u5DF2\u505C\u6B62",
    btn_start: "\u25B6 \u542F\u52A8\u670D\u52A1",
    btn_stop: "\u23F9 \u6682\u505C\u670D\u52A1",
    btn_processing: "\u23F3 \u5904\u7406\u4E2D...",
    scan_qr: "\u{1F4F1} \u624B\u673A\u626B\u7801\u6216\u6D4F\u89C8\u5668\u8BBF\u95EE\u4E0A\u65B9\u5730\u5740",
    guide_title: "\u{1F4D6} \u4F7F\u7528\u6307\u5357",
    guide_1: "\u70B9\u51FB\u4E0A\u65B9\u6309\u94AE\u542F\u52A8\u670D\u52A1\uFF0C\u786E\u4FDD\u72B6\u6001\u53D8\u7EFF\u3002",
    guide_2: "\u786E\u4FDD\u624B\u673A\u548C\u7535\u8111\u8FDE\u63A5\u540C\u4E00\u4E2A Wi-Fi\u3002",
    guide_3: "\u624B\u673A\u626B\u7801\u6216\u8F93\u5165\u5730\u5740\u6253\u5F00\u7F51\u9875\u3002",
    ...
    setting_port: "\u670D\u52A1\u7AEF\u53E3",
    setting_port_desc: "\u9ED8\u8BA4\u4E3A 27123\u3002\u4FEE\u6539\u540E\u9700\u70B9\u51FB\u53F3\u4FA7\u6309\u94AE\u3002",
  ...
  en: {
    plugin_name: "LAN Wireless Bridge",
    ribbon_tooltip: "Open LAN Bridge Dashboard",
    server_started: "Wireless Bridge Started (Port {0})",
    server_stopped: "Server Stopped",
    port_in_use: "\u274C Port {0} is in use!",
    start_failed: "\u274C Failed to start server",
    saved: "Saved",
    error: "Error",
    status_running: "\u{1F7E2} Service Running",
    ...
    risk_footer: "Disclaimer: LAN only. Author is not responsible for data loss due to overwriting. Please backup regularly.",
    setting_port: "Server Port",
    setting_port_desc: "Default 27123. Click button to apply.",
...
(0, import_obsidian.addIcon)("lan-dashboard", `<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>`);
...
var LanEditorPlugin = class extends import_obsidian.Plugin {
  ...
  async onload() {
    ...
    this.ribbonIconEl = this.addRibbonIcon("lan-dashboard", t("ribbon_tooltip"), () => {
  ...
  async handleRequest(req, res, vaultPath) {
    ...
    if (pathname === "/api/list") {
      ...
      files.sort((a, b) => {
        ...
        return ((fb == null ? void 0 : fb.stat.mtime) || 0) - ((fa == null ? void 0 : fa.stat.mtime) || 0);
      });
...
var LanEditorSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  async display() {
    ...
    Object.assign(statusDot.style, {
      ...
      marginBottom: "10px",
      backgroundColor: isRunning ? "#4caf50" : "#ff4d4f",
      boxShadow: isRunning ? "0 0 8px #4caf50" : "none"
    });
    statusCard.createEl("h3", { text: isRunning ? t("status_running") : t("status_stopped"), style: "margin:0 0 5px 0;" });
    if (isRunning)
      statusCard.createEl("div", { text: `URL: ${webUrl}`, style: "user-select:text; color:var(--text-accent); font-weight:bold;" });
    ...
    toggleBtn.onclick = async () => {
      ...
      if (isRunning)
        ...
        if (!success)
          toggleBtn.innerText = t("start_failed");
      }
      this.display();
    };
    if (isRunning) {
      const connectSection = containerEl.createDiv();
      connectSection.style.marginTop = "20px";
      ...
      connectSection.createEl("p", { text: t("scan_qr"), style: "opacity:0.7; font-size:0.9em;" });
    }
    ...
    steps.forEach((s) => guide.createEl("p", { text: s, style: "margin-bottom:5px;" }));
    ...
    warningBox.createEl("strong", { text: t("risk_desc_strong"), style: "color:red" });
    ...
    authorSection.style.marginTop = "30px";
    authorSection.style.opacity = "0.7";
    authorSection.createEl("span", { text: t("zyshunyx") + " " });
    const link = authorSection.createEl("a", { text: t("github"), href: "https://github.com/zyshunyx-lang/obsidian-lan-sync.git" });
    link.style.color = "var(--text-accent)";
    authorSection.createEl("p", { text: "\u5982\u679C\u89C9\u5F97\u597D\u7528\uFF0C\u8BF7\u7ED9\u4E2A Star \u2B50", style: "font-size:0.8em; margin-top:5px;" });
  }
};
